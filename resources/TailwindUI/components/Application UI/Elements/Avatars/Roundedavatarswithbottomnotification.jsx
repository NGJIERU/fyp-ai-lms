  ...
  return (
    <>
      ...
      <span className="relative inline-block">
        ...
        />
        <span className="absolute bottom-0 right-0 block translate-x-1/2 translate-y-1/2 transform rounded-full border-2 border-white">
          <span className="block size-2.5 rounded-full bg-gray-300" />
        </span>
      </span>
      ...
      <span className="relative inline-block">
        ...
        />
        <span className="absolute bottom-0 right-0 block translate-x-1/2 translate-y-1/2 transform rounded-full border-2 border-white">
          <span className="block size-3.5 rounded-full bg-gray-300" />
        </span>
      </span>
      ...
      <span className="relative inline-block">
        ...
        />
        <span className="absolute bottom-0 right-0 block translate-x-1/2 translate-y-1/2 transform rounded-full border-2 border-white">
          <span className="block size-4 rounded-full bg-gray-300" />
        </span>
      </span>
    </>
  )
