    ...
    <div className="mx-auto max-w-md sm:max-w-3xl">
      <div>
        ...
        <form action="#" className="mt-6 sm:flex sm:items-center">
          <div className="flex grow items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-600">
            <input
              name="emails"
              type="text"
              placeholder="Enter an email"
              aria-label="Email addresses"
              className="block min-w-0 grow py-1.5 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6"
            />
